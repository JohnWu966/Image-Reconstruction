 ...
 * that the scale operations performed by org.imgscalr be manageable so as not to
 ...
 * or limiting logic to handle these use-cases. Given org.imgscalr's popularity in
 * web applications it was determined that this requirement be common enough
 * that it should be integrated directly into the org.imgscalr library for everyone
 * to benefit from.
 * <p/>
...
public class AsyncScalr {
	 ...
	 * operations.
	 * <p/>
	 * Value is "<code>org.imgscalr.async.threadCount</code>".
	 */
	public static final String THREAD_COUNT_PROPERTY_NAME = "org.imgscalr.async.threadCount";
	 ...
	 * <code>org.imgscalr.async.threadCount</code> system property (see
