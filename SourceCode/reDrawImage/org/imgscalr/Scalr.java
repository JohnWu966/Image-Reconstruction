 ...
 * <p>
 * The results generated by org.imgscalr using this method, as compared to a single
 ...
 * by org.imgscalr to create a scaled instance <em>of the same type</em> as the
 ...
 * <p/>
 * org.imgscalr specifically accounts for and automatically hands
 ...
 * images even if you aren't using org.imgscalr for anything else.
 ...
 * is processed by org.imgscalr and the result saved as a GIF file (instead of PNG),
 ...
 * issues).
 * <p/>
 * org.imgscalr currently does nothing to work around this manually because it is a
 ...
 * allows the logging to be light weight and easy to capture (every org.imgscalr log
...
public class Scalr {
	 ...
	 * <p/>
	 * Value is "<code>org.imgscalr.debug</code>".
	 */
	public static final String DEBUG_PROPERTY_NAME = "org.imgscalr.debug";

	/**
	 * System property name used to define a custom log prefix.
	 * <p/>
	 * Value is "<code>org.imgscalr.logPrefix</code>".
	 */
	public static final String LOG_PREFIX_PROPERTY_NAME = "org.imgscalr.logPrefix";

	/**
	 * Flag used to indicate if debugging output has been enabled by setting the
	 * "<code>org.imgscalr.debug</code>" system property to <code>true</code>. This
	 * value will be <code>false</code> if the "<code>org.imgscalr.debug</code>"
	 ...
	 * class is loaded.
	 * <p/>
	 * Default value is "<code>[org.imgscalr] </code>" (including the space).
	 */
	public static final String LOG_PREFIX = System.getProperty(
			LOG_PREFIX_PROPERTY_NAME, "[org.imgscalr] ");
	 ...
	 * JDK that org.imgscalr is meant to replace).
	 * <p/>
	 ...
	 * org.imgscalr allows the {@link ConvolveOp} to create its own destination
	 ...
	 *             defined on the org.imgscalr API to make it easier for callers to
	 *             catch the exception (if they are passing along optional ops
	 *             to be applied). org.imgscalr takes detailed steps to avoid the
	 ...
	 *            The image that will be scaled.
	 * @param resizeMode
	 *            Used to indicate how org.imgscalr should calculate the final
	 ...
	 *            {@link Mode#AUTOMATIC} is passed in, org.imgscalr will calculate
	 ...
	 * code inside of the org.imgscalr library.
	 * <p/>
	 ...
	 * unmodified.
	 * <p/>
	 * This method is meant to be used by any calling code (org.imgscalr's or
	 ...
	 *            org.imgscalr) to use for this incremental scaling operation.
	 * @param interpolationHintValue
	 *            The {@link RenderingHints} interpolation value used to
	 *            indicate the method that {@link Graphics2D} should use when
	 *            scaling the image.
